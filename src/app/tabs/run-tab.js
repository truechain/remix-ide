...
function contractDropdown (events, self) {
  ...
  var atAddressButtonInput = yo`<input class="${css.input} ataddressinput" placeholder="从地址加载该合约" title="atAddress" />`
  ...
  function setInputParamsPlaceHolder () {
    ...
    if (self._deps.compiler.getContract && selectContractNames.selectedIndex >= 0 && selectContractNames.children.length > 0) {
      ...
      self._view.createPanel.innerHTML = '没有已编译的合约'
    }
  }
  ...
  var valueEl = yo`
    <div class="${css.crow}">
      ...
      <select name="unit" class="${css.col2_2}" id="unit">
        ...
        <option data-unit="true">true</option>
      </select>
    </div>
  `
  // DOM ELEMENT
